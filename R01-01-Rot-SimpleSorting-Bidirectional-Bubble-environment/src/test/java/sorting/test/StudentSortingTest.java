...
public class StudentSortingTest {
	...
	public void slicedTest(Integer[] array, int leftIndex, int rightIndex) {
		if (!(array == null || array.length == 0 ||
			leftIndex < 0 || rightIndex >= array.length || leftIndex > rightIndex)) {
	...
	public void testSort06() {
		slicedTest(vetorTamImpar, 3, 6);
	}

	@Test
	public void testSort07() {
		slicedTest(vetorTamPar, 3, 6);
	}

	@Test
	public void testSort08() {
		slicedTest(vetorValoresRepetidos, 3, 6);
	}

	@Test
	public void testSort09() {
		slicedTest(vetorValoresIguais, 3, 5);
	}

	@Test
	public void testSort10() {
		slicedTest(vetorVazio, 0, 0);
	}
